 ...
 */
require_once THUMBLIB_BASE_PATH . '/class.PhpThumb.php';
/**
 * Include the ThumbBase Class
 */
require_once THUMBLIB_BASE_PATH . '/class.ThumbBase.php';
/**
 * Include the GdThumb Class
 */
require_once THUMBLIB_BASE_PATH . '/class.GdThumb.php';
